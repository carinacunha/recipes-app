...
const CREME_FRAICHE = 'Creme Fraiche';
const SESAME_SEED_OIL = 'Sesame Seed Oil';
const THREE_FINELY_CHOPPED = '3 finely chopped';
const ONE_ONEHALF_CUPS = '1 1/2 cups ';
const SUNFLOWER_OIL = 'Sunflower Oil';
const GREEK_YOGURT = 'Greek Yogurt';
const LEMON_JUICE = 'Lemon Juice';
const ONE_FRESH_SPRIG = '1 fresh sprig';
...
export const mockFetchNull = { meals: null };

export const mockFetchRecipes = {
  meals: [
    {
      idMeal: '52977',
      strMeal: 'Corba',
    ...
    },
    {
      ...
      strIngredient5: SESAME_SEED_OIL,
    ...
    },
    {
      ...
      strIngredient19: '',
      strIngredient20: '',
      strMeasure1: ONE_ONEHALF_CUPS,
      strMeasure2: ONE_ONEHALF_CUPS,
      strMeasure3: '1/2 tsp',
      strMeasure4: '2 cups ',
      strMeasure5: 'Can',
      strMeasure6: '1 large',
    ...
    },
    {
      ...
      strMeasure7: '1',
      strMeasure8: '4 cups',
      strMeasure9: ONE_FRESH_SPRIG,
      strMeasure10: ONE_FRESH_SPRIG,
    ...
    },
    {
      ...
      strCategory: 'Vegetarian',
      strArea: 'Japanese',
      strInstructions: 'Boil some water in a large saucepan. Add 250ml cold water and the udon noodles. (As they are so thick, adding cold water helps them to cook a little bit slower so the middle cooks through). If using frozen or fresh noodles, cook for 2 mins or until al dente; dried will take longer, about 5-6 mins. Drain and leave in the colander.\r\nHeat 1 tbsp of the oil, add the onion and cabbage and sauté for 5 mins until softened. Add the mushrooms and some SPRING_ONIONS, and sauté for 1 more min. Pour in the remaining sesame oil and the noodles. If using cold noodles, let them heat through before adding the ingredients for the sauce – otherwise tip in straight away and keep stir-frying until sticky and piping hot. Sprinkle with the remaining SPRING_ONIONS.',
      ...
      strIngredient2: SESAME_SEED_OIL,
      strIngredient3: 'Onion',
...
export const mockFetchFiltered = {
  meals: [
    {
